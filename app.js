...
// refactor the sum function into an arrow function
let newSum = (a, b, c, d) =>  a + b + c + d;
console.log('by using the arrow function : ' + newSum(1, 2, 3, 4));
...
let newObjectLit = () => ({
    ...
    console.log('The arrow function for object: ' , newObjectLit());
...
console.log('other way for creating the function : ',sumAndProductArrowFun(3, 9));
...
console.log('other way for creating the function : ',message2('Allie'));
...
// let Student =(name, age, hometown) =>{ Will cause an error
//     this.name = name;
//     this.age = age;
//     this.hometown = hometown;
//   };
...
// here 'this' bound  to object which is the Student object.
// 2. What is "this" when joe.scopeArrow() is invoked?
//here this reverse to global which is the Window
// 3. Explain why "this" is different when an arrow function is used.
//With normal functions the scoped is bound to the global one by default but the Arrow functions do not bind their own this, instead, they inherit the one from the parent scope, which is called "lexical scoping". 

//How long you spent working on this assignment? about 45 min 